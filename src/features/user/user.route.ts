...
import { getMeController, loginUserController, registerUserController } from './user.controller';
...
userRouter.get('/me', authRequired, schoolSubdomainRequired, asyncWrapper(getMeController));
